...
<amp-img class="author-thumb-post" height="{{ page.height }}" width="{{ page.width }}" alt="{{ page.title }}" layout="responsive" src="{{ site.url }}/assets/sprekers/floris-venneman.png" ></amp-img>
